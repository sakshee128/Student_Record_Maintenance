...
<body>
	...
	<div class="contact1">
		<div class="container-contact1">
			...
			<form class="contact1-form validate-form" action="Register">
				...
				<div class="wrap-input1 validate-input" data-validate = "Password is required" required/>
					<input class="input1" name="password" placeholder="PASSWORD"></input>
					<span class="shadow-input1"></span>
				</div>
